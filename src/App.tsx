...
import { CloudProvider } from '@/cloud/CloudGate'
...
const router = createHashRouter([
  {
    ...
    children: [
      ...
      { path: 'services/new', element: <ServiceFormPage key="service-new" /> },
      { path: 'services/:id/edit', element: <ServiceFormPage key="service-edit" /> },
      { path: 'services/:id', element: <ServiceDetailPage /> },
      { path: 'reports', element: <ReportsPage /> },
      { path: 'equipment', element: <EquipmentPage /> },
      { path: 'calls', element: <CallsPage /> },
      { path: 'quotations', element: <QuotationsPage /> },
      { path: 'quotations/new', element: <QuotationFormPage key="quotation-new" /> },
